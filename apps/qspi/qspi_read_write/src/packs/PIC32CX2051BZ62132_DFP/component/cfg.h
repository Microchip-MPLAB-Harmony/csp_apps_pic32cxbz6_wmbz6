...
/* file generated from device description file (ATDF) version 2024-05-07T20:51:46Z */
...
#define CFG_CFGI2C_SLRTEN3_Pos                _UINT32_(27)                                         /* (CFG_CFGI2C) SLRT Enable for SERCOM3 Position */
#define CFG_CFGI2C_SLRTEN3_Msk                (_UINT32_(0x1) << CFG_CFGI2C_SLRTEN3_Pos)            /* (CFG_CFGI2C) SLRT Enable for SERCOM3 Mask */
#define CFG_CFGI2C_SLRTEN3(value)             (CFG_CFGI2C_SLRTEN3_Msk & (_UINT32_(value) << CFG_CFGI2C_SLRTEN3_Pos)) /* Assigment of value for SLRTEN3 in the CFG_CFGI2C register */
#define CFG_CFGI2C_SLRTEN4_Pos                _UINT32_(28)                                         /* (CFG_CFGI2C) SLRT Enable for SERCOM4 Position */
#define CFG_CFGI2C_SLRTEN4_Msk                (_UINT32_(0x1) << CFG_CFGI2C_SLRTEN4_Pos)            /* (CFG_CFGI2C) SLRT Enable for SERCOM4 Mask */
#define CFG_CFGI2C_SLRTEN4(value)             (CFG_CFGI2C_SLRTEN4_Msk & (_UINT32_(value) << CFG_CFGI2C_SLRTEN4_Pos)) /* Assigment of value for SLRTEN4 in the CFG_CFGI2C register */
#define CFG_CFGI2C_SLRTEN5_Pos                _UINT32_(29)                                         /* (CFG_CFGI2C) SLRT Enable for SERCOM5 Position */
#define CFG_CFGI2C_SLRTEN5_Msk                (_UINT32_(0x1) << CFG_CFGI2C_SLRTEN5_Pos)            /* (CFG_CFGI2C) SLRT Enable for SERCOM5 Mask */
#define CFG_CFGI2C_SLRTEN5(value)             (CFG_CFGI2C_SLRTEN5_Msk & (_UINT32_(value) << CFG_CFGI2C_SLRTEN5_Pos)) /* Assigment of value for SLRTEN5 in the CFG_CFGI2C register */
...
#define CFG_CFGI2C_Msk                        _UINT32_(0x7F474747)                                 /* (CFG_CFGI2C) Register Mask  */
...
#define CFG_CFGI2C_SLRTEN_Msk                 (_UINT32_(0x7F) << CFG_CFGI2C_SLRTEN_Pos)            /* (CFG_CFGI2C Mask) SLRTEN */
